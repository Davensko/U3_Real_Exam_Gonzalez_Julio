...
void rotateGun(WbDeviceTag *gun) {
  wb_motor_set_position(gun[0], INFINITY);
  wb_motor_set_velocity(gun[0], -2);
}

void stopGun(WbDeviceTag *gun) {
  wb_motor_set_position(gun[0], INFINITY);
  wb_motor_set_velocity(gun[0], 0);
}
/*
void impresion(WbDeviceTag distance_sensor) {
